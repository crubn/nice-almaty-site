...
function buildSystemPrompt(opts) {
  ...
  const lines = [
    ...
    opts.skipGreeting
      ? "GREETING: Do NOT greet in this reply. Do not write «Сәлеметсіз бе», «Здравствуйте», «Hello» or any hello — continue straight to the answer."
...
function resolveSkipGreeting(opts) {
  ...
  return hist.some((m) => m.role === "assistant");
}
...
async function ask(opts) {
  ...
  const skipGreeting = resolveSkipGreeting(opts);
